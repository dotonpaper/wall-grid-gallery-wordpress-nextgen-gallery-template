...
<script type="text/JavaScript">
    var DOPNextGENWallGridGallerySettings<?php echo $gallery->ID;?> = {
        ...
        "Height": 450, // Height (value in pixels). Default value: 0. Set the height of the gallery. If you set the value to 0 all thumbnails are going to be displayed.
        ...
        "NoColumns": 7, // Number of Columns (auto, number). Default value: 4. Set the number of columns for the grid.
        ...
        "ThumbnailsPaddingRight": 15, // Thumbnails Padding Right (value in pixels). Default value: 0. Set the right padding for the thumbnails.
        ...
        "ThumbnailsNavigation": "scroll", // Thumbnails Navigation (mouse, scroll). Default value: mouse. Set how you navigate through the thumbnails.
        "ThumbnailsScrollScrubColor": "afbd21", // Thumbnails Scroll Scrub Color (color hex code). Default value: 777777. Set the scroll scrub color.
        "ThumbnailsScrollBarColor": "e0e0e0", // Thumbnails Scroll Bar Color (color hex code). Default value: e0e0e0. Set the scroll bar color.
        "ThumbnailsInfo": "none", // Info Thumbnails Display (none, tooltip, label). Default value: none. Display a small info text on the thumbnails, a tooltip or a label on bottom.
        ...
        "ThumbnailWidth": 100, // Thumbnail Width (the size in pixels). Default value: 200. Set the width of a thumbnail.
        "ThumbnailHeight": 100, // Thumbnail Height (the size in pixels). Default value: 100. Set the height of a thumbnail.
        "ThumbnailWidthMobile": 50, // Mobile Thumbnail Width (the size in pixels). Default value: 100. Set the width of a thumbnail on mobile devices.
        ...
        "ThumbnailBgColor": "9fad9f", // Thumbnail Background Color (color hex code). Default value: cccccc. Set the color of a thumbnail's background.
        "ThumbnailBgColorHover": "c1d72e", // Thumbnail Background Color Hover (color hex code). Default value: 000000. Set the color of a thumbnail's background when hover.
        ...
        "LightboxPosition": "gallery", // Lightbox Position (document, gallery). Default value: document. If the value is document the lightbox is displayed over the web page fitting in the browser's window, else the lightbox is displayed in the gallery's container.
        "LightboxWindowColor": "ffffff", // Lightbox Window Color (color hex code). Default value: 000000. Set the color for the lightbox window.
        "LightboxWindowAlpha": 100, // Lightbox Window Alpha (value from 0 to 100). Default value: 80. Set the transparency for the lightbox window.
        "LightboxLoader": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/LightboxLoader2.gif", // Lightbox Loader (path to image). Set the loader for the lightbox image.
        "LightboxBgColor": "ffffff", // Lightbox Background Color (color hex code). Default value: 000000. Set the color for the lightbox background.
        ...
        "LightboxMarginTop": 0, // Lightbox Margin Top (value in pixels). Default value: 70. Set top margin value for the lightbox.
        "LightboxMarginRight": 0, // Lightbox Margin Right (value in pixels). Default value: 70. Set right margin value for the lightbox.
        "LightboxMarginBottom": 0, // Lightbox Margin Bottom (value in pixels). Default value: 70. Set bottom margin value for the lightbox.
        "LightboxMarginLeft": 0, // Lightbox Margin Left (value in pixels). Default value: 70. Set top left value for the lightbox.
        "LightboxPaddingTop": 0, // Lightbox Padding Top (value in pixels). Default value: 10. Set top padding value for the lightbox.
        "LightboxPaddingRight": 0, // Lightbox Padding Right (value in pixels). Default value: 10. Set right padding value for the lightbox.
        "LightboxPaddingBottom": 0, // Lightbox Padding Bottom (value in pixels). Default value: 10. Set bottom padding value for the lightbox.
        "LightboxPaddingLeft": 0, // Lightbox Padding Left (value in pixels). Default value: 10. Set left padding value for the lightbox.
        ...
        "CaptionHeight": 24, // Caption Height (value in pixels). Default value: 75. Set caption height.
        "CaptionTitleColor": "222222", // Caption Title Color (color hex code). Default value: eeeeee. Set caption title color.
...
<?php
        ...
        foreach ($images as $image):
            ...
            echo '{"Image": "'.$image->imageURL.'",'.
                  ...
                  '"Media": \''.preg_replace('`[\r\n]`', "<br />", stripslashes($image->ngg_custom_fields['Media'])).'\','.
