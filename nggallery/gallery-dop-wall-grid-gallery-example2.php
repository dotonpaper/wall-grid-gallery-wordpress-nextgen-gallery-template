...
<script type="text/JavaScript">
    var DOPNextGENWallGridGallerySettings<?php echo $gallery->ID;?> = {
        ...
        "ThumbnailsInfo": "label", // Info Thumbnails Display (none, tooltip, label). Default value: none. Display a small info text on the thumbnails, a tooltip or a label on bottom.
        "ThumbnailLoader": "<?php echo get_template_directory_uri()?>/nggallery/assets/gui/images/ThumbnailLoader2.gif", // Thumbnail Loader (path to image). Set the loader for the thumbnails.
        ...
        "ThumbnailAlpha": 100, // Thumbnail Alpha (value from 0 to 100). Default value: 80. Set the transparency of a thumbnail.
        ...
        "ThumbnailBgColor": "000000", // Thumbnail Background Color (color hex code). Default value: cccccc. Set the color of a thumbnail's background.
        "ThumbnailBgColorHover": "afbd21", // Thumbnail Background Color Hover (color hex code). Default value: 000000. Set the color of a thumbnail's background when hover.
        ...
        "LightboxMarginTop": 50, // Lightbox Margin Top (value in pixels). Default value: 70. Set top margin value for the lightbox.
        "LightboxMarginRight": 50, // Lightbox Margin Right (value in pixels). Default value: 70. Set right margin value for the lightbox.
        "LightboxMarginBottom": 50, // Lightbox Margin Bottom (value in pixels). Default value: 70. Set bottom margin value for the lightbox.
        "LightboxMarginLeft": 50, // Lightbox Margin Left (value in pixels). Default value: 70. Set top left value for the lightbox.
        ...
        "CaptionHeight": 100, // Caption Height (value in pixels). Default value: 75. Set caption height.
        ...
        "LabelTextColor": "ffffff", // Label Text Color (color hex code). Default value: 000000. Set label text color.
